...
@Component({
  selector: 'app-all-products-disabled-filter-backend',
  templateUrl: './all-products-disabled-filter-backend.component.html',
  styleUrl: './all-products-disabled-filter-backend.component.css'
})
export class AllProductsDisabledFilterBackendComponent {
  ...
  setElements(): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.productService.getAllProductsDisabledFilteredSortered(this.currentPage, this.pageSize, this.selectedSort, this.selectedCategory).subscribe({
        next: (res) =>{
        //console.log(res);
